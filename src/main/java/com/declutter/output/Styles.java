...
public final class Styles {
  public static final String DEFAULT_STYLE = "MINIMALIST_SWISS";

  public static final Map<String, String> STYLES = Map.ofEntries(
      Map.entry("MINIMALIST_SWISS", """
* {
  margin: 0;
  padding: 0;
