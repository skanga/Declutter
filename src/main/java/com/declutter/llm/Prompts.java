...
public final class Prompts {
  private static final String DOCUMENT_PLACEHOLDER = "__DOCUMENT_DATA__";

  public static String inputPrompt(String document) {
    return """
Now declutter the text provided in the document section 
<document>
""" + document + """
